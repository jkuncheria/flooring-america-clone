  ...
  const services = [
    {
      ...
      description: 'At The Carpet Corner, we offer a diverse range of flooring options to suit every style and budget. From hardwood to carpet, we\'ve got you covered! We carry the following manufacturers: Mohawk, Shaw, Dream Weaver, Dixie, Royal Dutch by Stanton, and more.'
    },
    {
    ...
    },
    {
      ...
      description: 'At The Carpet Corner, we believe that everyone deserves beautiful flooring without breaking the bank. That\'s why we offer competitive pricing on all of our products and services. We also offer free estimates!'
    },
    {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-2xl md:text-3xl font-bold text-gray-700">
                  <span className="text-yellow-500">Since 1974</span> - Family Owned
                </p>
                <p className="text-lg text-gray-600 mt-3">
                  We are a family-owned and operated business serving Mundelein, Libertyville, Lake Forest and surrounding areas. We provide quality installations of Carpet, Hardwood, Luxury Vinyl, Laminate, Tile, and Sheet Vinyl.
                </p>
              </div>
            </div>
          </div>
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Transform Your Home With <span className="text-blue-900">The Carpet Corner</span>
          </h2>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-2xl p-12 md:p-16 mb-24 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-blue-100 leading-relaxed mb-6">
              Since 1974, The Carpet Corner has been a trusted name in flooring, built on the foundation of family values, integrity, and a commitment to excellence. As a family-owned and operated business, we understand that your home is more than just a house—it's where memories are made.
            </p>
        ...
        <div className="bg-gray-50 rounded-2xl p-8 md:p-12">
          <div className="max-w-4xl mx-auto">
            <h3 className="text-3xl font-bold text-gray-900 mb-8 text-center">Why Choose The Carpet Corner?</h3>
            <div className="space-y-4">
              <div className="flex items-start bg-white rounded-xl p-6 shadow-sm">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 mb-2">50+ Years of Family Tradition</h4>
                  <p className="text-gray-600">Since 1974, we've been serving Mundelein and surrounding communities. Our decades of experience mean we've seen it all and know how to handle every flooring challenge with expertise and care.</p>
                </div>
              </div>
              <div className="flex items-start bg-white rounded-xl p-6 shadow-sm">
                <CheckCircle className="w-6 h-6 text-blue-900 mr-4 flex-shrink-0 mt-1" />
              ...
              <div className="flex items-start bg-white rounded-xl p-6 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-600">We partner with leading manufacturers including Mohawk, Shaw, Dream Weaver, Dixie, Royal Dutch by Stanton, and more to bring you the best selection.</p>
                </div>
              </div>
              <div className="flex items-start bg-white rounded-xl p-6 shadow-sm">
                <CheckCircle className="w-6 h-6 text-blue-900 mr-4 flex-shrink-0 mt-1" />
